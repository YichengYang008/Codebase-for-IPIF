...
train_model(){
    python main_scripts.py --model_name $1 --batch_size ${batch_size} --epochs 100 \
...
test_model(){
    python main_scripts.py --model_name $1 --batch_size 10000000 --epochs 5 \
    --data_file ${data_file} --types_file ${types_file} --miss_file ${miss_file} \
    --dim_latent_z $2 --dim_latent_y $3 --dim_latent_s $4 \
