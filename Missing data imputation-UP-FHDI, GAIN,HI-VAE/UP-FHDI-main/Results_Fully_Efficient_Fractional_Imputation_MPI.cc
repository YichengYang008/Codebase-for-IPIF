	...
	//----------------------
{
	...
	//testout
	//RPrint("d_ipmat1_FEFI :");
	//RPrint(d_ipmat1_FEFI, i_row_imat_FEFI, 4+ncol); 


	//---
	//final return matrix of impat of FEFI
	//---
	//rbind_FHDI  rbind_ipmat_FEFI(4+ncol); //column size is 4+ncol //defined outside 
	...
	//if (mynode == 0) cout << "Result1 Running time is " << MPI_Wtime() - Result_1 << endl;
	//testout
	//RPrint("rbind_ipmat_FEFI after binding :");
	...
	//test---------
	//int* i_order_ipmat_FEFI2 = new int[i_row_ipmat_FEFI];
	//for (int i = 0; i<i_row_ipmat_FEFI; i++) i_order_ipmat_FEFI2[i] = rbind_ipmat_FEFI(i, 0);
	//---------------
	//if (mynode == 0) {
	//	for (int i = 0; i < i_row_ipmat_FEFI;i++) {
	//		cout << "ipmat_FEFI[" << i << "]: " << i_order_ipmat_FEFI[i] << endl;
	//	}
	//}

	//if (mynode == 0) cout << "i_row_ipmat_FEFI is " << i_row_ipmat_FEFI << endl;
	//printf("This is the unsorted array: ");

	//for (int c = 0; c < i_row_ipmat_FEFI; c++) {

	//	printf("%d ", i_order_ipmat_FEFI[c]);
	...
	//if (mynode == 0) {
	//	for (int i = 0; i < i_row_ipmat_FEFI; i++) {
	//		cout << "mynode: " << mynode << " i_order_ipmat_FEFI before[" << i << "]: " << i_order_ipmat_FEFI[i] << endl;
	//	}
	//}

	//order_FHDI(i_order_ipmat_FEFI, i_row_ipmat_FEFI);
	//for (int i = 0; i < i_row_ipmat_FEFI; i++) {
	//	cout <<"mynode: "<<mynode<< " i_order_ipmat_FEFI after[" <<i<<"]: "<< i_order_ipmat_FEFI[i]<<endl;
	//}
	if (i_row_ipmat_FEFI < totalnodes) {
		cout<<"Error!!!!! The size of i_order_ipmat_FEFI is too small for parallel"<<endl;
		return;
	}
	order_FHDI_Yicheng(i_order_ipmat_FEFI, i_row_ipmat_FEFI);


	//if (mynode == 0) {
	//	for (int i = 0; i < i_row_ipmat_FEFI; i++) {
	//		cout << "mynode: " << mynode << "serial[" << i << "]: " << i_order_ipmat_FEFI[i] << endl;
	//	}
	//}

	//if (mynode == 0) {
	//	for (int i = 0; i < i_row_ipmat_FEFI; i++) {
	//		cout << "mynode: " << mynode << "parallel[" << i << "]: " << i_order_ipmat_FEFI2[i] << endl;
	//	}
	//}
	//Parallel_MergeSort(i_order_ipmat_FEFI, i_row_ipmat_FEFI);
	...
	//testout
	//RPrint("======== after FEFI ============");
	//RPrint("ipmat_FEFI: "); rbind_ipmat_FEFI.print_rbind_FHDI();
	...
	for (int i = 0; i<ncol; i++)
	{
		...
		{
			int i_repeat = v_table_count_1stcol_ipmat[k]; // Yicheng:each pattern same counts with rbind_impat_FEFI
	...
	//---------
	//testout
	//RPrint("Resp_FEFI: "); RPrint(d_Resp_FEFI, i_row_ipmat_FEFI, ncol+1);
	...
	//testout
	//RPrint("d_irmat1_FEFI :");
	//RPrint(d_irmat1_FEFI, i_row_imat_FEFI, 5+ncol); 
	...
	//testout
	//RPrint("rbind_irmat_FEFI after binding :");
	...
	//	cout << "mynode: " << mynode << " before[" << i << "]: " << i_order_irmat_FEFI[i] << endl;
	//}
	//order_FHDI(i_order_irmat_FEFI, i_row_irmat_FEFI);
	if (i_row_irmat_FEFI < totalnodes) {
		cout<<"Error!!!! The size of i_order_irmat_FEFI is too small for parallel"<<endl;
		return;
	}
	order_FHDI_Yicheng(i_order_irmat_FEFI, i_row_irmat_FEFI);
	
	//for (int i = 0; i < i_row_irmat_FEFI; i++) {
	//	cout << "mynode: " << mynode << " final[" << i << "]: " << i_order_irmat_FEFI[i] << endl;
	//}
	//Parallel_MergeSort(i_order_irmat_FEFI, i_row_irmat_FEFI);
	//backup before re-order
	...
	//testout
	//RPrint("======== after FEFI ============");
	//RPrint("irmat_FEFI: "); rbind_irmat_FEFI.print_rbind_FHDI();
