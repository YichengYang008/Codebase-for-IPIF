...
#include "Merge_Extension_Bigp_cpp.cc"
...

{
	...
	*/
	...
	//Ranking_m(nrow, ncol, x, r, correlation_yicheng, correlation_ranking, TestOut);
	...
	//cout << "top_correlation in cell make bigp is " << top << endl;

	double Ranking_top_begin = MPI_Wtime();
	...
	//if (mynode == 0) {
	//	//cout << "YYC Running time of Cell_make at node " << mynode << " = " << MPI_Wtime() - cell_make_begin << endl;
	//	printf("Yicheng Running time of Ranking_top = %f seconds\n", MPI_Wtime() - Ranking_top_begin);
	//}
	//for (int i = 0; i < ncol; i++) {
	//	for (int j = 0; j < ncol; j++) {
...

	{
		...
		*/
		...
		//-----------
		double Zmat_iteration = MPI_Wtime();
		...
		//if (mynode == 0) {
		//	cout << "Zmat_Extension_cpp at iteration: " << i_loop << endl;
		//}
		...
		//if (mynode == 0) {
		//	cout << "YYC Running time of ZMAT at iteration " << i_loop << " = " << MPI_Wtime() - Zmat_iteration << endl;
		//}
		...
		*/
		...
		List_FHDI List_nU(i_count_mox);

		//List_FHDI* address = &List_nU;
		...
		//tnU = NULL;
		int* tnU = new int[i_count_uox]; Fill_iVector(tnU, i_count_uox, 0);
		...
		//if (mynode == 2) {
		//	cout << "Codes at i_loop " << i_loop << endl;

		//	for (int kk2 = 0; kk2 < nrow; kk2++) {
		//		for (int kk3 = 0; kk3 < i_collapsing; kk3++) {
		//			cout << setw(20) << codes[kk2][kk3];
		//		}
		//		cout << endl;
		//	}
		//	cout << "nDAU_Bip at i_loop " << i_loop << endl;
		//}

		//if (mynode == 0) {
		//	cout << "nDAU_Bigp_cpp_MPI at iteration: " << i_loop << endl;
		//}
		//testout
		//if (mynode == 0) {
		//	cout<<"Print List_nu where i_count_mox = "<< i_count_mox <<" and i_count_uox = "<< i_count_uox <<" at iteration "<< i_loop <<endl;
		...
		//if (mynode == 0) {
		//	cout << "YYC Running time of nDAU at iteration " << i_loop << " = " << MPI_Wtime() - cell_make_check3_nDAU << endl;
		//}
		...
		*/
...

		{
			...
			Merge_Extension_Bigp_cpp(i_reci, uox, i_count_uox,
				...
				i_merge, codes, i_collapsing,

				b_DEBUG_Merge, TestOut);
		...
		//if (mynode == 0) {
		//	cout << "YYC Running time of Merge at iteration " << i_loop << " = " << MPI_Wtime() - cell_make_check4 << endl;
		//}
		...
		//if (mynode == 0) {
		//	cout << "YYC Running time of Cell_make at iteration " << i_loop << " = " << MPI_Wtime() - cell_make_check_iteration << endl;
		//}

		//std::vector<int>().swap(v_nD);
		//List_nU.~List_FHDI();
	...
	//TestOut << "Final Codes in cell make" << endl;
