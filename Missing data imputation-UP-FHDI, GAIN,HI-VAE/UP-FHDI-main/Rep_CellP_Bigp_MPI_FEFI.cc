...
#include "Cell_Prob_Extension_Bigp_cpp.cc"

void Rep_CellP_Bigp_FEFI(double** d_cx, const int nrow, const int ncol, const int i_collapsing,
	RepWeight_FHDI &d_rw, int*  id,
	List_FHDI        &List_rst_prob,
	List_string_FHDI &List_rst_name,
	std::vector<std::string> &s_ncx, int** codes, ofstream& TestOut)
	//Description============================================
	...
	*/
	...
	for (int i = startpoint; i<endpoint; i++)
	{
		...
		*/
		...
		Cell_Prob_Extension_Bigp_cpp(d_cx, nrow, ncol, i_collapsing,
			jp_prob_return,
			jp_name_return,
			w_UserDefined, id, codes, TestOut);
