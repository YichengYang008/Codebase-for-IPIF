#include "Cell_Prob_Neighbor_cpp.cc"
//#include "Cell_Prob_Extension_cpp_MPI.cc"

void Rep_CellP_Neighbor_FEFI(double** d_cx, const int nrow, const int ncol, 
	RepWeight_FHDI &d_rw, int*  id, List_FHDI &List_nU,
	...
	*/
	...
	for (int i = startpoint; i<endpoint; i++)
	{
		...
		*/
		...
		Cell_Prob_Neighbor_cpp(d_cx, nrow, ncol, List_nU,
			jp_prob_return,
			jp_name_return,
