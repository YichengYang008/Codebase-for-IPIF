#include "AGMAT_Neighbor_cpp_MPI.cc"
#include "Cal_W_Neighbor_cpp_MPI.cc"

void Cell_Prob_Neighbor_cpp_MPI(double** z, const int nrow, const int ncol, List_FHDI &List_nU,
...
//====================================================
{
	...
	*/
	...
	AGMAT_Neighbor_cpp(mox, i_count_mox, 
						uox, i_count_uox, 
						ncol, id, 
						v_table_tmvec_row1,
						v_table_tmvec_row2,
	...
	*/
	...
	{
		//cout<<"Version check 1 at iterations "<< i_loop <<endl;
		//------------
		...
		Cal_W_Neighbor_cpp_MPI(mox, i_count_mox, 
						uox, i_count_uox, 
						ncol, id, List_nU,
						v_table_tmvec_row1,
						v_table_tmvec_row2,
