...
def main(args):
    ...
    ##############################################
    daty_file = open("data/daty_column_binary.bin", 'rb')
    datr_file = open("data/datr_column_binary.bin", 'rb')
    ...
    print('miss_data_x type is ', type(miss_data_x))
    ...
    np.savetxt('imputed.txt', imputed_data_x, fmt='%1.5f')
    ...
    rmse = rmse_loss(ori_data_x, imputed_data_x, nrow, ncol)
